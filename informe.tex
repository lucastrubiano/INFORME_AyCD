...
\begin{itemize}
	...
	\item Velocidad máxima : ±1,5 m/s (con carga nominal); ±3,0 m/s (sin carga). Esto es para mantenerse dentro de la curva de potencia constante durante el izaje. Ver figura (4).
\end{itemize}
