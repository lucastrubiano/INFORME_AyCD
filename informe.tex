...
\begin{itemize}
	...
	\end{figure}
	\item \textbf{NIVEL 1 >\ MARCHA >\ OPERACION >\ MODO:}  Es el encargado de determinar cuando operamos en un modo u otro. Si es \textbf{MANUAL} el operario no podrá superar las velocidades asignadas. El modo \textbf{AUTOMATICO} se activa cuando salimos de la envolvente. Ver figura \ref{fig:nivel_1_modo}.
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{images/imagen_18_nivel_1_modo.png}
		\caption{Diagrama de StateFlow del controlador \textbf{NIVEL 1 >\ MARCHA >\ OPERACION >\ MODO}.}
		\label{fig:nivel_1_modo}
	\end{figure}
	\item \textbf{NIVEL 1 >\ MARCHA >\ OPERACION >\ TRAYECTORIA:} En este modo se coordina el seguimiento de la trayectoria. Tenemos un proceso de \textbf{CALCULO POSICION} que determina las etapas del movimiento desde su posición inicial, el movimiento de \textbf{HOSTING}, y hasta el final. También analiza si estamos en una trayectoria simple o combinada. Ver figura \ref{fig:nivel_1_trayectoria}.
	\begin{figure}[!h]
		\centering
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=0.7\textwidth]{images/imagen_21_nivel_1_longitud_lh.png}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=0.8\textwidth]{images/imagen_22_nivel_1_pos_container.png}
